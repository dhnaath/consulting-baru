  ...
  return (
    <div className="flex flex-col min-h-screen bg-background relative overflow-hidden">
      <div className="p-4 flex items-center gap-3 pt-6 shrink-0 bg-background">
        ...
        <h1 className="text-lg font-medium text-foreground tracking-wide">Perencanaan Suksesi</h1>
      </div>
      ...
      <div ref={ref} onScroll={onScroll} className="flex-1 overflow-y-auto p-6 pb-20">
        ...
        <div className="bg-card p-8 rounded-2xl border border-border text-center mb-8">
          <p className="text-muted-foreground/70 text-sm">Belum ada ahli waris yang ditambahkan.</p>
        </div>

        <h3 className="text-muted-foreground text-sm font-medium mb-4 uppercase tracking-wider">
          Dokumen & Instruksi Khusus
        </h3>
        <div className="bg-card p-8 rounded-2xl border border-border text-center mb-8">
          <p className="text-muted-foreground/70 text-sm">Belum ada dokumen instruksi khusus.</p>
        </div>
      </div>
    </div>
  );
