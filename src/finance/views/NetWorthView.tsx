    ...
    <div className="flex flex-col min-h-screen bg-background relative overflow-hidden">
      ...
      <div ref={ref} onScroll={onScroll} className="flex-1 overflow-y-auto p-6 pb-20">
        ...
        <div className="bg-card p-8 rounded-2xl border border-border mb-8 text-center">
          <p className="text-muted-foreground/70 text-sm">Belum ada aset didaftarkan.</p>
        </div>
        ...
        <div className="bg-card p-8 rounded-2xl border border-border mb-8 text-center">
          <p className="text-muted-foreground/70 text-sm">Belum ada liabilitas didaftarkan.</p>
        </div>
      </div>
    </div>
  );
