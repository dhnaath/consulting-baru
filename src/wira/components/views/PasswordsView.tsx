  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto w-full h-full flex flex-col">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Passwords</h1>
          <p className="text-muted-foreground text-sm mt-1">
            Securely manage your passwords and secrets.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-border rounded-3xl bg-card/50 p-8">
        ...
        <h3 className="text-xl font-bold text-foreground">No passwords saved</h3>
        <p className="text-muted-foreground mt-2 max-w-md text-center">
          Add your first secure password entry.
        </p>
      </div>
    </div>
  );
